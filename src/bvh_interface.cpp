...
int BvhInterface::numOfInternalNodes() const
{
    return m_impl->numOfInternalNodes();
}
...
void BvhInterface::drawSplit(int internalNodeIdx) {
    m_impl->drawSplit(internalNodeIdx);
}
