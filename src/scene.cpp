...
Scene loadScenePrebuilt(SceneType type, const std::filesystem::path& dataDir)
{
    ...
    std::filesystem::path skyBox = DATA_DIR;

    scene.cubeMap = { Image { skyBox / "posx.jpg" }, Image { skyBox / "negx.jpg" },
        Image { skyBox / "posy.jpg" }, Image { skyBox / "negy.jpg" }, 
        Image { skyBox / "posz.jpg" }, Image { skyBox / "negz.jpg" } };
